...
function TheoryHome({ onOpenAlphabet, onOpenDiphthongs }: TheoryHomeProps) {
  return (
    <>
...
function PracticeHome({ onOpenDictionaryTopics, onOpenWriteWordTopics }: PracticeHomeProps) {
  return (
    <>
      <header className="app__header">
...
export default function HomeScreen({
  ...
  return <TheoryHome onOpenAlphabet={onOpenAlphabet} onOpenDiphthongs={onOpenDiphthongs} />;
}
